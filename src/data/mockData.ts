...
export const INITIAL_BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    quotation: {
      laborCost: 150000,
      parts: [
        { id: 'part-3', name: 'Nạp gas bổ sung R32/R410A', unitPrice: 200000, quantity: 1 },
      ],
      extraCharges: [],
      totalAmount: 350000,
      status: 'pending',
  ...
  },
  {
    ...
    quotedAt: '2026-07-20T11:30:00Z',
    createdAt: '2026-07-20T09:00:00Z',
    surveyAt: '2026-07-20T10:00:00Z',
    inProgressAt: '2026-07-20T10:30:00Z',
...
export const DEMO_USERS: User[] = [
  {
    ...
    phone: '0912 333 444',
    role: 'customer',
    avatar: 'https://ui-avatars.com/api/?name=Hoang+Thu+Trang&background=2563eb&color=fff&bold=true',
...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    technicianReply: 'Cảm ơn chị Trang đã tin tưởng dịch vụ. Nếu máy có vấn đề gì chị cứ gọi em theo số hotline trên phiếu bảo hành nhé!'
  },
  {
    id: 'rev-2',
  ...
  },
  {
    ...
    rating: 5,
    ratings: { quality: 5, attitude: 5, punctuality: 5, pricing: 4 },
    comment: 'Anh Tuấn dò đúng điểm ống rẽ nhánh bị nứt ngầm mà lúc khảo sát chưa thấy, xử lý dứt điểm không còn thấm tường nữa. Có báo phát sinh rõ ràng trước khi làm thêm.',
    serviceName: 'Sửa đường ống nước bục vỡ, rò rỉ âm tường',
    photos: [
      'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=600&q=80',
    ],
    createdAt: '2026-07-20T15:00:00Z',
    technicianReply: 'Cảm ơn chị Trang, có gì cứ nhắn em hỗ trợ tiếp nhé!'
  },
  {
    id: 'rev-6',
